  ...
  return (
    <>
        ...
        <div className='container text-white'>
          <Row>
            <Col md='6'>
              ...
              <p className='exhibitor-description' dangerouslySetInnerHTML={{ __html: t('profile.description') }} />
              <div className='home-files-download gap-5'>
                <a className='home-register' href='/files/Floorplan-ITM-2024-21-12-2023.pdf' target='_blank' rel='noreferrer'>
      ...
      <div className='pt-5 pb-5 text-black text-center'>
        ...
        <a className='text-black' href='mailto:eder.rangel@igeco.mx'>eder.rangel@igeco.mx</a>
      </div>
    </>
  )
}
