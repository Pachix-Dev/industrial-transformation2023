      ...
      <Container className='pt-5 mt-5 text-center home-counterdown-timer'>
        ...
        <div className='pt-5'>
          ...
          <p className='text-light'>
            ...
            <svg width={15} viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg' stroke='#ffffff'>
            ...
            <small className='text-light mt-3 mb-0'>
          ...
          <div className='mt-5'>
            ...
            <small className='mt-3 text-light' dangerouslySetInnerHTML={{ __html: t('home.leyend') }} />
          </div>
        </div>
      </Container>
    )
