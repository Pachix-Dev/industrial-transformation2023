    ...
    <>
      ...
      <div className='home-counter-video'>
        ...
        <div className='home-files-download'>
          <a className='home-register' href='/files/Floorplan-ITM-2024-15-12-2023.pdf' target='_blank' rel='noreferrer'>
          ...
          {/* <a className='home-register' href='/files/Factsheet-ITM-2024V1.pdf' target='_blank' rel='noreferrer'>
