const speakers = [
  {
    ...
    img: '/speakers/AlejandroPreinfalk.webp',
  ...
  },
  {
    ...
    company: 'Schneider Electric',
    rol: 'Sales Manager',
    img: '/speakers/MariaFernandaSilva.webp',
    resume: 'La combinación de tecnologías digitales y automatización están impulsando una transformación sostenible en el sector industrial. Descubrirás cómo la integración de soluciones inteligentes, como la digitalización de la red eléctrica y la gestión eficiente de la energía, está promoviendo la eficiencia energética, reduciendo las emisiones y fomentando la sostenibilidad en las industrias.',
  ...
  },
  {
    ...
    img: '/speakers/MonserratPuebla.webp',
  ...
  },
  {
    ...
    img: '/speakers/IrisRodriguez.webp',
    resume: 'Descubra cómo la diversidad de género impulsa la innovación y el crecimiento en el campo de la ingeniería, y cómo la inclusión de más mujeres en puestos técnicos y de liderazgo beneficia a toda la industria. A través de historias inspiradoras y experiencias personales, nuestros oradoras compartirán ideas y consejos sobre cómo superar los desafíos y lograr el éxito en un entorno tradicionalmente dominado por hombres.',
  ...
  },
  {
    ...
    img: '/speakers/FernandaGarcia.webp',
  ...
  },
  {
    ...
    img: '/speakers/SilviaOrtizRuiz.webp',
  ...
  },
  {
    ...
    img: '/speakers/RobertoTepoz.webp',
  ...
  },
  {
    ...
    company: 'Schneider Electric',
    rol: 'System & Architecture Senior Engineer ',
    img: '/speakers/EduardoEspino.webp',
    resume: 'La norma IEC 61499 revoluciona la automatización industrial desde la flexibilidad y modularidad hasta la interoperabilidad y reutilización de componentes. Aprenderás cómo la IEC 61499 impulsa la eficiencia, la escalabilidad y la agilidad en los procesos industriales, abriendo el camino hacia las Industrias del Futuro.',
  ...
  },
  {
    ...
    img: '/speakers/JavierJesusGarcía.webp',
  ...
  },
  {
    ...
    img: '/speakers/SamuelAceves.webp',
  ...
  },
  {
    ...
    img: '/speakers/CesarArteaga.webp',
  ...
  },
  {
    ...
    company: 'Schneider Electric',
    rol: 'Business Development Manager',
    img: '/speakers/JuanAlbertoLopez.webp',
    resume: 'Explora el futuro de la industria a través de la lente de la automatización con Schneider Electric. Acompáñanos en esta charla inspiradora mientras desentrañamos cómo la automatización impulsa la eficiencia, la agilidad y la sostenibilidad en las Industrias del Futuro. Descubre cómo nuestras soluciones líderes están forjando el camino hacia una industria más inteligente, sostenible y competitiva.',
  ...
  },
  {
    ...
    img: '/speakers/VictorBulnes.webp',
  ...
  },
  {
    ...
    img: '/speakers/AbigailCarrillo.webp',
  ...
  },
  {
    ...
    img: '/speakers/VirginiaGuerere.webp',
    resume: '¿Innovacion sostenible, eficiente y accionable para tus edificaciones comerciales? La tecnología para ello ya existe. Descubre de la mano de nuestras expertas, Abigail Carrillo - Meetering Business Developer y Virginia Guerere - Building Automation Business Developer, todo lo que la digitalizacion, medicion y automatizacion de las edificaciones pueden brindarte. Hablamos desde ahorro de energia hasta ahorro operativo y de mantenimiento. Las instalaciones comerciales e industriales pueden ser eficientes al mismo tiempo que sostenibles.',
    sketch: 'Ingeniero Eléctrico egresada de la Universidad del Zulia, experta en Habilitar la oferta y equipos de automatizacion de edificios, para el desarrollo del negocio de BMS (Buildings Management Systems) en Mexico y Centro America.'
  }
]
export { speakers }
